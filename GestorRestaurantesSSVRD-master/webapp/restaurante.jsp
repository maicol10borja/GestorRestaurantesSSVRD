...
<%
    Restaurante restaurante = (Restaurante) session.getAttribute("carro");
%>
<html>
<head>
...
<%
    if (restaurante == null || restaurante.getItems().isEmpty()) {
...
<table>
    ...
    <%
        for (ItemRestaurante item : restaurante.getItems()) {%>
    <tr>
